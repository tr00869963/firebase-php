...
use Kreait\Firebase\Project\Builder;
use Kreait\Firebase\Project\Config;
use Kreait\Firebase\Project\FactoryBasedProjectBuilder;
...
final class Firebase
{
    ...
    public function __construct(?Builder $projectBuilder = null)
    {
        $this->projectBuilder = $projectBuilder ?? new FactoryBasedProjectBuilder();
    }
    ...
    public function initializeProject(?Config $config = null, ?string $name = null): Project
    {
        ...
        $this->projects[$name] = $this->projectBuilder->buildProject($config);
